...
channelToSensor: dict[str, Sensor] = {
    ...
    "AIN3": Sensor("MASS_g", SensorTypeID.MASS, 0, dataConversions.genericAmplifier((0, 100*1000), (0, 5))), # (g, V)
    "AIN2": Sensor("P1_mPSI", SensorTypeID.PRESSURE, 1, dataConversions.genericAmplifier((0, 1000*1000), (0, 5))), # (mPSI, V)
    "AIN4": Sensor("P2_mPSI", SensorTypeID.PRESSURE, 2, dataConversions.genericAmplifier((0, 1000*1000), (0, 5))), # (mPSI, V)
    "AIN5": Sensor("P3_mPSI", SensorTypeID.PRESSURE, 3, dataConversions.genericAmplifier((0, 1000*1000), (0, 5))), # (mPSI, V)
    "AIN6": Sensor("P4_mPSI", SensorTypeID.PRESSURE, 4, dataConversions.genericAmplifier((0, 1000*1000), (0, 5))), # (mPSI, V)
    "AIN7": Sensor("P5_mPSI", SensorTypeID.PRESSURE, 5, dataConversions.genericAmplifier((0, 1000*1000), (0, 5))), # (mPSI, V)
    "AIN8": Sensor("P6_mPSI", SensorTypeID.PRESSURE, 6, dataConversions.genericAmplifier((0, 1000*1000), (0, 5))), # (mPSI, V)
    "AIN9": Sensor("P7_mPSI", SensorTypeID.PRESSURE, 7, dataConversions.genericAmplifier((0, 1000*1000), (0, 5))), # (mPSI, V)
